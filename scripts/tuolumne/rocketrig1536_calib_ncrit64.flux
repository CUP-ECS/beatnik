#!/bin/bash
# flux: --job-name=rk1536_calib_n64
# flux: --nodes=64
# flux: --exclusive
# flux: --time=30
...
# per-step wallclock. fmm_ncrit = 64 (validated). Pairs with the ncrit=128
...
RUN_DIR="${BASE_DIR}/calib_ncrit64"
SRC_INPUT="${BASE_DIR}/single_mode_calib_ncrit64.in"
...
echo ":::"
echo "::: CALIBRATION fmm_ncrit=64  | 1536^2 B=24 | 256 ranks / 64 nodes | 50 steps"
