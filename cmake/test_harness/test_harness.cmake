...
macro(Beatnik_add_tests_nobackend)
  cmake_parse_arguments(Beatnik_UNIT_TEST "" "PACKAGE" "NAMES" ${ARGN})
...
macro(Beatnik_add_tests)
  cmake_parse_arguments(BEATNIK_UNIT_TEST "MPI" "PACKAGE" "NAMES" ${ARGN})
  set(BEATNIK_UNIT_TEST_MPIEXEC_NUMPROCS 1)
  foreach( _np 2 4 )
    if(MPIEXEC_MAX_NUMPROCS GREATER_EQUAL ${_np})
      list(APPEND BEATNIK_UNIT_TEST_MPIEXEC_NUMPROCS ${_np})
    endif()
  endforeach()
  if(MPIEXEC_MAX_NUMPROCS GREATER 4)
    list(APPEND BEATNIK_UNIT_TEST_MPIEXEC_NUMPROCS ${MPIEXEC_MAX_NUMPROCS})
  endif()
