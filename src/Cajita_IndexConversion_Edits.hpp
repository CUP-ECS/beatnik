...
/*!
  \file Cajita_IndexConversion_Edits.hpp
  \brief Local to global index conversion
*/
#ifndef CAJITA_INDEXCONVERSION_EDITS_HPP
#define CAJITA_INDEXCONVERSION_EDITS_HPP
...
namespace Cajita
{
namespace IndexConversion_Edits
{
//---------------------------------------------------------------------------//
...
struct L2G
{
    ...
    //! Local node space
    Cajita::IndexSpace<num_space_dim> local_own_space;
...
#endif // end CAJITA_INDEXCONVERSION_EDITS_HPP
